...
class EditMedicationScreen extends StatefulWidget {
  ...
  const EditMedicationScreen({super.key, required this.dose});
...
class _EditMedicationScreenState extends State<EditMedicationScreen> {
  ...
  Future<void> _loadScheduledMedication() async {
    try {
      ...
      final scheduledMeds = await controller.getAllScheduledMedicationsFromDB();
    ...
    if (_formKey.currentState!.validate() && _scheduledMedication != null) {
      try {
        ...
        final updatedMedication = ScheduledMedication(
          ...
          medicamentoId: _scheduledMedication!.medicamentoId,
          dataCriacao: _scheduledMedication!.dataCriacao,
        );

        // Atualizar no banco de dados através do controller
        await controller.updateScheduledMedication(updatedMedication);
